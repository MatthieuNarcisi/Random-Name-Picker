package com.randomappsinc.scoutpicker.adapters;
...
public class NameChoosingAdapter extends BaseAdapter {
    ...
    private void addPointAtPosition(int position) {
        currentState.addPointAtPosition(position);
        notifyDataSetChanged();
        setViews();
    }

    private void removePointAtPosition(int position) {
        currentState.removePointAtPosition(position);
        notifyDataSetChanged();
        setViews();
    }
    ...
    public class NameViewHolder {
        ...
        public void addPoint() { addPointAtPosition(position); }

        @OnClick(R.id.minus_icon)
        public void removePoint() { removePointAtPosition(position); }
    }
