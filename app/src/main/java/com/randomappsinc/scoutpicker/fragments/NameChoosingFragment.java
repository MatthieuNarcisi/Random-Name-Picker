package com.randomappsinc.scoutpicker.fragments;
...
import com.randomappsinc.scoutpicker.activities.MainActivity;
import com.randomappsinc.scoutpicker.activities.PresentationActivity;
import com.randomappsinc.scoutpicker.adapters.NameChoosingAdapter;
import com.randomappsinc.scoutpicker.database.DataSource;
import com.randomappsinc.scoutpicker.models.ChoosingSettings;
import com.randomappsinc.scoutpicker.models.ChoosingSettingsViewHolder;
...
import com.randomappsinc.scoutpicker.utils.UIUtils;
import com.randomappsinc.scoutpicker.views.ChoicesDisplayDialog;
...
public class NameChoosingFragment extends Fragment
    ...
    public void choose() {
        ...
        if (mSettings.getPresentationMode()) {
            ...
            ListInfo info = PreferencesManager.get().getNameListState(mListName);
            info = info == null ? new DataSource().getListInfo(mListName) : info;

            List<Integer> chosenIndexes = NameUtils.getRandomNumsInRange(mSettings.getNumNamesToChoose(),
                    mNameChoosingAdapter.getNumInstances() - 1, info.getNameScores());
