package com.randomappsinc.scoutpicker.database;
...
public class DataSource {
    ...
    public ListInfo getListInfo(String listName) {
        ...
        int amount = 0;
        open();
        String[] columns = {MySQLiteHelper.COLUMN_PERSON_NAME, MySQLiteHelper.COLUMN_NAME_COUNT, MySQLiteHelper.COLUMN_PERSON_SCORE};
        ...
        while (cursor.moveToNext()) {
            ...
            nameScores.put(cursor.getString(0), cursor.getInt(2));
            names.add(cursor.getString(0));
            amount += cursor.getInt(1);
        }
        cursor.close();
        close();
        return new ListInfo(nameAmounts, nameScores, names, amount, new ArrayList<String>());
    }
    ...
    public void addNames(String name, String listName, int amount) {
        ...
        if (currentAmount == 0) {
            ...
            // Default score of all players : 0
            values.put(MySQLiteHelper.COLUMN_PERSON_SCORE, 0);
